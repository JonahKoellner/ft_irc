...
#    Updated: 2024/01/02 15:13:18 by mreidenb         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES = Server.cpp User.cpp Chat.cpp Executer.cpp Executer_FileTransfer.cpp Commander.cpp Commands.cpp Commands_Channel.cpp ClientHandler.cpp Database.cpp
