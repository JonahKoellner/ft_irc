...
/*   Updated: 2023/10/17 14:15:13 by jkollner         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	Executer::send_message_user_chat(int userSocketFD, std::string message) {
	std::unordered_map<int, User> users = this->_database.get_channel_user(this->_database.get_user(userSocketFD).get_channel());
